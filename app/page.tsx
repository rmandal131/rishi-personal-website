  ...
  return (
    <section>
      ...
      <ul className="mb-8 list-disc pl-6 space-y-2">
        ...
        <li>Currently: Co-founder of Future. Hyper-personalized coaching to improve consumer health and fitness. We're building Future with Tom Brady, and backed by Kleiner Perkins, a16z, Khosla Ventures, and more</li>
