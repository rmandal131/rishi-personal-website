  ...
  return (
    <section>
      ...
      <ul className="mb-8 list-disc pl-6 space-y-2">
        ...
        <li>Currently: I am the co-founder of Future, where we have scaled 1-on-1 coaching to improve the health and well-being of consumers around the world. We've built Future with Tom Brady, and we are backed by Kleiner Perkins, Andreessen Horowitz, Khosla Ventures, and others</li>
