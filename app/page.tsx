  ...
  return (
    <section>
      ...
      <ul className="mb-8 list-disc pl-6 space-y-2">
        ...
        <li>Currently: Cofounder of Future. Scaling 1-on-1 coaching to improve the health of consumers around the world. We're building Future with Tom Brady. Backed by Kleiner Perkins, A16Z, Khosla Ventures, and others</li>
